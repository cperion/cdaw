...
local lower_param_value = terralib.memoize(function(self)
    local source
...
function D.Editor.ParamValue:lower()
    return diag.wrap(nil, "editor.param_value.lower", "real", function()
        return lower_param_value(self)
    end, function()

...
function D.Editor.Slot:lower(ctx)
    return diag.wrap(ctx, "editor.slot.lower", "real", function()
        local content = F.slot_content_e2a(self.content)

        -- Convert follow action
        local follow = nil
        ...
        local behavior = D.Authored.LaunchBehavior(
            ...
            self.behavior.quantize_override
                and F.quantize_e2a(self.behavior.quantize_override)
                or nil,

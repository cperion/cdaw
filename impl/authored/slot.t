...
local resolve_slot = terralib.memoize(function(self)
...
function D.Authored.Slot:resolve()
    return diag.wrap(nil, "authored.slot.resolve", "real", function()
        return resolve_slot(self)
    end, function()
